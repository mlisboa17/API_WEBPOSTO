...
const navMain = [
  ...
  { title: "Tanques", url: "/tms/cadastros/tanques", icon: DatabaseIcon },
  { title: "Veiculos", url: "/tms/cadastros/veiculos", icon: TruckIcon },
  { title: "Motoristas", url: "/tms/cadastros/motoristas", icon: IdCardIcon },

...
COMMERCIAL_FAMILIES: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("CONGELADO_PRONTO", ("COXINHA", "PASTEL", "PIZZA", "LASANHA", "EMPADA", "ESFIHA",
                          ...
                          "SANDUICHE", "HOT POCKET", "TORTA SALGADA")),
    ("ENLATADO", ("SARDINHA", "ATUM", "FEIJOADA", "MILHO VERDE", "ERVILHA", "SELETA",
                  "SALSICHA", "PATE", "CONSERVA")),
    ("DOCE_ARTESANAL", ("COCADA", "PACOCA", "PACOQUINHA", "RAPADURA", "DOCE DE LEITE",
                        "PE DE MOLEQUE", "MARIA MOLE", "BOLO DE ROLO")),
    ("PETSHOP", ("RACAO", "PETISCO CAO", "PETISCO GATO", "AREIA HIGIENICA")),

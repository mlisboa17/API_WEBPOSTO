...
WEBPOSTO_ENDPOINT_CONTRACTS: dict[str, WebPostoEndpointContract] = {
    ...
    "grupo": WebPostoEndpointContract(
        path="/INTEGRACAO/GRUPO",
        requires_date_range=False,
        supports_pagination=True,
        payload_shape="resultados",
        min_timeout_seconds=10.0,
    ...
    "grupo_meta": WebPostoEndpointContract(
        path="/INTEGRACAO/GRUPO_META",
        requires_date_range=False,
        supports_pagination=True,
        payload_shape="resultados",
        min_timeout_seconds=10.0,
        description="Metas por grupo de produtos",
    ),

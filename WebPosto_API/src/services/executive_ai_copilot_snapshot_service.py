"""Snapshot F05.3 — Executive AI Copilot."""
...
class ExecutiveAiCopilotSnapshotService:
    def __init__(
        self,
        service: ExecutiveAiCopilotService | None = None,
        output_dir: str = "snapshots/executive_ai_copilot",
        ttl_seconds: float = COPILOT_TTL,
    ) -> None:
        self._service = service or ExecutiveAiCopilotService()
    ...
    def master_key(cls, data_inicial: str, data_final: str, empresa_codigo: str | int | None) -> str:
        return f"copilot:executive:{cls._suffix(data_inicial, data_final, empresa_codigo)}"

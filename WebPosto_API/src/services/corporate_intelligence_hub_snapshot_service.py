"""Snapshot F05.0 — Corporate Intelligence Hub."""
...
HUB_SNAPSHOT_TTL_SECONDS = 300.0


class CorporateIntelligenceHubSnapshotService:
    def __init__(
        self,
        service: CorporateIntelligenceHubService | None = None,
        output_dir: str = "snapshots/corporate_intelligence_hub",
        ttl_seconds: float = HUB_SNAPSHOT_TTL_SECONDS,
    ) -> None:
        self._service = service or CorporateIntelligenceHubService()
    ...
    def master_key(cls, data_inicial: str, data_final: str, empresa_codigo: str | int | None) -> str:
        return f"corporate:hub:{cls._suffix(data_inicial, data_final, empresa_codigo)}"

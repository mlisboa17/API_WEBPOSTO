"""Snapshot F06.1 — NFCE Intelligence."""
...
NFCE_INTEL_TTL = 300.0


class NfceIntelligenceSnapshotService:
    def __init__(
        self,
        service: NfceIntelligenceService | None = None,
        output_dir: str = "snapshots/nfce_intelligence",
        ttl_seconds: float = NFCE_INTEL_TTL,
    ) -> None:
        self._service = service or NfceIntelligenceService()
    ...
    def master_key(cls, data_inicial: str, data_final: str, empresa_codigo: str | int | None) -> str:
        return f"nfce:intel:{cls._suffix(data_inicial, data_final, empresa_codigo)}"

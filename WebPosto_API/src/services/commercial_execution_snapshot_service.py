"""Snapshot F07.7 — Commercial Execution & Outcome Tracking."""
...
COMMERCIAL_EXECUTION_TTL = 300.0


class CommercialExecutionSnapshotService:
    def __init__(
        self,
        service: CommercialExecutionService | None = None,
        output_dir: str = "snapshots/commercial_execution",
        ttl_seconds: float = COMMERCIAL_EXECUTION_TTL,
    ) -> None:
        self._service = service or CommercialExecutionService()
    ...
    def master_key(cls, data_inicial: str, data_final: str, empresa_codigo: str | int | None) -> str:
        return f"commercial:execution:{cls._suffix(data_inicial, data_final, empresa_codigo)}"

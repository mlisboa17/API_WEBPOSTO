"""Snapshot F06.3 — Tax & Product Fiscal Intelligence."""
...
FISCAL_INTEL_TTL = 300.0


class TaxProductFiscalIntelligenceSnapshotService:
    def __init__(
        self,
        service: TaxProductFiscalIntelligenceService | None = None,
        output_dir: str = "snapshots/fiscal_intelligence",
        ttl_seconds: float = FISCAL_INTEL_TTL,
    ) -> None:
        self._service = service or TaxProductFiscalIntelligenceService()
    ...
    def master_key(cls, data_inicial: str, data_final: str, empresa_codigo: str | int | None) -> str:
        return f"fiscal:intel:{cls._suffix(data_inicial, data_final, empresa_codigo)}"

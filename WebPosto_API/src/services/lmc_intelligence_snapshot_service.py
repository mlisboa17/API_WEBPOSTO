"""Snapshot F06.2 — LMC Intelligence."""
...
class LmcIntelligenceSnapshotService:
    def __init__(
        self,
        service: LmcIntelligenceService | None = None,
        output_dir: str = "snapshots/lmc_intelligence",
        ttl_seconds: float = LMC_INTEL_TTL,
    ) -> None:
        self._service = service or LmcIntelligenceService()
    ...
    def master_key(cls, data_inicial: str, data_final: str, empresa_codigo: str | int | None) -> str:
        return f"lmc:intel:{cls._suffix(data_inicial, data_final, empresa_codigo)}"
